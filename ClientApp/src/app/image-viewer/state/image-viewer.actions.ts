...
export const loadNewImage = createAction('[Image Viewer Api] Load New Image', props<{ webcamSettings: WebcamSettings, lightSettings: SmartLightSettings, isDeleteLastImage: boolean }>());
